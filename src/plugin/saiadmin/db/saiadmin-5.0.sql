...
-- ----------------------------
-- Table structure for __PREFIX__article
-- ----------------------------
...
-- ----------------------------
-- Records of __PREFIX__article_banner
-- ----------------------------
INSERT INTO `__PREFIX__article_banner` VALUES (1, 1, 'https://image.saithink.top/saiadmin/d758c454ef03c49ac7185c7290b020e2.jpg', 1, '/app/saicms/index/article?id=5', '周也热巴带火猫塑女风 如何打造猫系女孩妆容', 1, 0, NULL, 1, 1, '2024-06-02 23:06:37', '2024-07-31 16:24:15', NULL);
INSERT INTO `__PREFIX__article_banner` VALUES (2, 1, 'https://image.saithink.top/saiadmin/eb5cc8b9ad1c3e562bae8af25ce630eb.jpg', 1, '/app/saicms/index/article?id=6', '深度 | 明星穿高定亮相红毯，为何遭客户投诉？', 1, 0, NULL, 1, 1, '2024-06-02 23:06:49', '2024-07-31 16:24:23', NULL);
INSERT INTO `__PREFIX__article_banner` VALUES (3, 1, 'https://image.saithink.top/saiadmin/995de531bb0c5fd2dac8e8d9e0421344.jpg', 1, '/app/saicms/index/article?id=7', '荣耀正在筹备一大波新品 两款折叠屏＋X60＋ GT新机', 1, 0, NULL, 1, 1, '2024-06-02 23:06:56', '2024-07-31 16:24:34', NULL);

-- ----------------------------
-- Table structure for __PREFIX__article_category
-- ----------------------------
...
-- ----------------------------
-- Records of __PREFIX__article_category
-- ----------------------------
INSERT INTO `__PREFIX__article_category` VALUES (1, 0, '体育', '', NULL, 100, 1, 1, 1, '2024-06-02 22:50:51', '2024-07-31 17:24:49', NULL);
INSERT INTO `__PREFIX__article_category` VALUES (2, 0, '娱乐', '', NULL, 100, 1, 1, 1, '2024-06-02 22:50:56', '2024-07-20 23:01:30', NULL);
INSERT INTO `__PREFIX__article_category` VALUES (3, 0, '科技', '', NULL, 100, 1, 1, 1, '2024-06-02 22:51:01', '2024-07-20 19:49:47', NULL);
INSERT INTO `__PREFIX__article_category` VALUES (4, 1, 'NBA', NULL, NULL, 100, 1, 1, 1, '2024-06-02 22:51:16', '2024-06-02 22:51:16', NULL);
INSERT INTO `__PREFIX__article_category` VALUES (5, 1, '英超', NULL, NULL, 100, 1, 1, 1, '2024-06-02 22:51:39', '2024-06-02 22:51:39', NULL);
INSERT INTO `__PREFIX__article_category` VALUES (6, 1, '中超', NULL, NULL, 100, 1, 1, 1, '2024-06-02 22:51:49', '2024-06-02 22:51:49', NULL);
INSERT INTO `__PREFIX__article_category` VALUES (7, 2, '时尚', NULL, NULL, 100, 1, 1, 1, '2024-06-02 22:52:03', '2024-06-02 22:52:03', NULL);
INSERT INTO `__PREFIX__article_category` VALUES (8, 2, '女性', NULL, NULL, 100, 1, 1, 1, '2024-06-02 22:52:12', '2024-06-02 22:52:12', NULL);
INSERT INTO `__PREFIX__article_category` VALUES (9, 3, '手机', NULL, NULL, 100, 1, 1, 1, '2024-06-02 22:52:37', '2024-06-02 22:52:37', NULL);
INSERT INTO `__PREFIX__article_category` VALUES (10, 3, '生活', NULL, NULL, 100, 1, 1, 1, '2024-06-08 13:37:51', '2024-06-08 13:37:51', NULL);

-- ----------------------------
-- Table structure for __PREFIX__system_attachment
-- ----------------------------
DROP TABLE IF EXISTS `__PREFIX__system_attachment`;
CREATE TABLE `__PREFIX__system_attachment`  (
...
-- ----------------------------
-- Records of __PREFIX__system_attachment
-- ----------------------------
...
CREATE TABLE `__PREFIX__system_menu`  (
  ...
  `is_layout` tinyint(1) UNSIGNED NULL DEFAULT 1 COMMENT '继承layout',
...
-- ----------------------------
-- Records of __PREFIX__system_user_post
-- ----------------------------
...
-- ----------------------------
-- Records of __PREFIX__tool_crontab
-- ----------------------------
INSERT INTO `__PREFIX__tool_crontab` VALUES (1, '访问官网', 1, 'https://saithink.top', NULL, 1, '0 0 8 * * *', 2, 1, NULL, 1, 2, '2024-01-20 14:21:11', '2025-04-29 17:54:32', NULL);
INSERT INTO `__PREFIX__tool_crontab` VALUES (2, '登录gitee', 2, 'https://gitee.com/check_user_login', '{\"user_login\": \"saiadmin\"}', 1, '0 0 10 * * *', 2, 1, NULL, 1, 1, '2024-01-20 14:31:51', '2025-04-28 00:08:34', NULL);
...
-- ----------------------------
-- Records of __PREFIX__tool_crontab_log
-- ----------------------------
